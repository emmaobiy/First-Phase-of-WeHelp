...
async def member_page(request: Request):
    if checkLogin(request):
        ...
        # 獲取更新姓名的API URL
        update_api_url = "/api/member"
        return templates.TemplateResponse("member-page.html", {"request": request, "name": name, "message": message, "update_api_url": update_api_url})
